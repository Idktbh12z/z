    ...
    script.Parent.MouseButton1Down:Connect(
        function()
            ...
            local ValiantAimHacks =
                loadstring(game:HttpGetAsync("https://raw.githubusercontent.com/Idktbh12z/z/main/main.lua"))()
                        ...
                        if ValiantAimHacks.checkSilentAim() then
                            ...
                            if
                                CPlayer and CPlayer.Character and
                                    CPlayer.Character.FindFirstChild(CPlayer.Character, "HumanoidRootPart")
                             then
